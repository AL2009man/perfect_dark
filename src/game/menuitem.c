		...
		if ((curmode < CONTROLMODE_21 || curmode == CONTROLMODE_PC) || (i >= 4 && i <= 7)) {
			...
			switch (i) {
				case 0: // L_MPWEAPONS_185 - "L/R BUTTONS:" -> L and R triggers
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "L/R BUTTONS", g_MpPlayerNum, CK_LTRIG, 0);
					break;
				case 1: // L_MPWEAPONS_186 - "UP C BUTTON:" -> C-Up
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "UP C BUTTON", g_MpPlayerNum, CK_C_U, 0);
					break;
				case 2: // L_MPWEAPONS_187 - "LEFT/RIGHT C BUTTONS:" -> C-Left/Right
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "LEFT/RIGHT C BUTTONS", g_MpPlayerNum, CK_C_L, 0);
					break;
				case 3: // L_MPWEAPONS_188 - "DOWN C BUTTON:" -> C-Down
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "DOWN C BUTTON", g_MpPlayerNum, CK_C_D, 0);
					break;
				case 4: // L_MPWEAPONS_189 - "A BUTTON:" -> A button
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "A BUTTON", g_MpPlayerNum, CK_A, 0);
					break;
				case 5: // L_MPWEAPONS_190 - "B BUTTON:" -> B button
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "B BUTTON", g_MpPlayerNum, CK_B, 0);
					break;
				...
				case 7: // L_MPWEAPONS_192 - "Z BUTTON:" -> Z trigger
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "Z BUTTON", g_MpPlayerNum, CK_ZTRIG, 0);
					break;
				case 8: // L_MPWEAPONS_193 - "+ CONTROL PAD:" -> D-pad
					glyphInputBindingDetect(buttonText, sizeof(buttonText), "+ CONTROL PAD", g_MpPlayerNum, CK_DPAD_U, 0);
					break;
				default:
					// No replacement
					break;
